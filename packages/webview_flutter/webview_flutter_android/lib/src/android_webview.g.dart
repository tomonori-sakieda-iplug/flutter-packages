...
class JavaScriptPanel {
  ...
  static JavaScriptPanel decode(Object result) {
    result as List<Object?>;
    return JavaScriptPanel(
      type: JavaScriptPanelType.values[result[0]! as int],
    );
  }
}
...
class JavaScriptPanelCompletionData {
  ...
  static JavaScriptPanelCompletionData decode(Object result) {
    result as List<Object?>;
    return JavaScriptPanelCompletionData(
...
class _WebChromeClientFlutterApiCodec extends StandardMessageCodec {
  ...
  @override
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is JavaScriptPanel) {
      buffer.putUint8(128);
      writeValue(buffer, value.encode());
    } else if (value is JavaScriptPanelCompletionData) {
      buffer.putUint8(129);
      writeValue(buffer, value.encode());
    } else {
      super.writeValue(buffer, value);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128: 
        return JavaScriptPanel.decode(readValue(buffer)!);
      case 129: 
        return JavaScriptPanelCompletionData.decode(readValue(buffer)!);
      default:
        return super.readValueOfType(type, buffer);
    }
  }
...
abstract class WebChromeClientFlutterApi {
  ...
  Future<JavaScriptPanelCompletionData?> runJavaScriptPanel(int instanceId, int webViewInstanceId, JavaScriptPanel type, String message, String? defaultText);
  ...
  static void setup(WebChromeClientFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.WebChromeClientFlutterApi.runJavaScriptPanel', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.runJavaScriptPanel was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.runJavaScriptPanel was null, expected non-null int.');
          final int? arg_webViewInstanceId = (args[1] as int?);
          assert(arg_webViewInstanceId != null,
              'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.runJavaScriptPanel was null, expected non-null int.');
          final JavaScriptPanel? arg_type = (args[2] as JavaScriptPanel?);
          assert(arg_type != null,
              'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.runJavaScriptPanel was null, expected non-null JavaScriptPanel.');
          final String? arg_message = (args[3] as String?);
          assert(arg_message != null,
              'Argument for dev.flutter.pigeon.WebChromeClientFlutterApi.runJavaScriptPanel was null, expected non-null String.');
          final String? arg_defaultText = (args[4] as String?);
          final JavaScriptPanelCompletionData? output = await api.runJavaScriptPanel(arg_instanceId!, arg_webViewInstanceId!, arg_type!, arg_message!, arg_defaultText);
          return output;
        });
      }
    }
