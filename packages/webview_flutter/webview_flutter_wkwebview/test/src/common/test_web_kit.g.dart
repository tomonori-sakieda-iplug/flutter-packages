...
abstract class TestWKPreferencesHostApi {
  ...
  static void setup(TestWKPreferencesHostApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.WKPreferencesHostApi.enableJavaScriptCanOpenWindowsAutomatically', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.WKPreferencesHostApi.enableJavaScriptCanOpenWindowsAutomatically was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.WKPreferencesHostApi.enableJavaScriptCanOpenWindowsAutomatically was null, expected non-null int.');
          final bool? arg_enabled = (args[1] as bool?);
          assert(arg_enabled != null,
              'Argument for dev.flutter.pigeon.WKPreferencesHostApi.enableJavaScriptCanOpenWindowsAutomatically was null, expected non-null bool.');
          api.enableJavaScriptCanOpenWindowsAutomatically(arg_identifier!, arg_enabled!);
          return <Object?>[];
        });
      }
    }
