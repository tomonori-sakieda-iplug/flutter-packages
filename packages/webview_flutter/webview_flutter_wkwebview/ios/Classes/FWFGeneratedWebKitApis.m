...
- (void)runJavaScriptAlertPanelForDelegateWithIdentifier:(NSNumber *)arg_identifier data:(FWFWKJavaScriptPanelData *)arg_data completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.webview_flutter_wkwebview.WKUIDelegateFlutterApi.runJavaScriptAlertPanel"
      binaryMessenger:self.binaryMessenger
      codec:FWFWKUIDelegateFlutterApiGetCodec()];
  [channel sendMessage:@[arg_identifier ?: [NSNull null], arg_data ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
- (void)runJavaScriptConfirmPanelForDelegateWithIdentifier:(NSNumber *)arg_identifier data:(FWFWKJavaScriptPanelData *)arg_data completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
...
- (void)runJavaScriptTextInputPanelForDelegateWithIdentifier:(NSNumber *)arg_identifier data:(FWFWKJavaScriptPanelData *)arg_data completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
