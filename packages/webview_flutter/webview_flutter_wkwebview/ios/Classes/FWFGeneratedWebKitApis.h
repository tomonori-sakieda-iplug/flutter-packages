...
- (void)enableJavaScriptCanOpenWindowsAutomaticallyForPreferencesWithIdentifier:(NSNumber *)identifier isEnabled:(NSNumber *)enabled error:(FlutterError *_Nullable *_Nonnull)error;
@end
