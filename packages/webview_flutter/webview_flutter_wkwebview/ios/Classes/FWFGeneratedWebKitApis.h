...
- (void)runJavaScriptAlertPanelForDelegateWithIdentifier:(NSNumber *)identifier data:(FWFWKJavaScriptPanelData *)data completion:(void (^)(FlutterError *_Nullable))completion;
/// Callback to Dart function `WKUIDelegate.runJavaScriptConfirmPanel`.
- (void)runJavaScriptConfirmPanelForDelegateWithIdentifier:(NSNumber *)identifier data:(FWFWKJavaScriptPanelData *)data completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
/// Callback to Dart function `WKUIDelegate.runJavaScriptTextInputPanel`.
- (void)runJavaScriptTextInputPanelForDelegateWithIdentifier:(NSNumber *)identifier data:(FWFWKJavaScriptPanelData *)data completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
@end
